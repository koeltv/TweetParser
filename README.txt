### README - Tweet Parser - CSVM Project

Description : Offre un parser descendant implémenté en Javascript dans le but de lire et manipuler des fichiers de Tweet. Les fichiers sont au format CSV et doivent respecter la grammaire suivante.

Jeu de données test : donneesSujetA (les données test fournies disponibles sur Moodle)
